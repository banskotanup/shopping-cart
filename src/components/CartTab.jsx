            ...
            <div key={cartItem.id}>
              <div className={styles.cartContent}>
                ...
                <div className={styles.cartBtns}>
                  <button onClick={() => decrementQuantity(cartItem.id)}>
                    -
                  </button>
                  <p>{cartItem.quantity}</p>
                  <button onClick={() => incrementQuantity(cartItem.id)}>
                    +
                  </button>
                </div>
                <h3 className={styles.tot}>
              ...
              <div className={styles.resCartContent}>
                <div className={styles.imgName}>
                  <img src={cartItem.image} alt="cart image" />
                </div>
                <div className={styles.btnAndDel}>
                <h3 className={styles.h3ContTit}>{cartItem.title}</h3>
                  <div className={styles.cartBtns}>
                    <button onClick={() => decrementQuantity(cartItem.id)}>
                      -
                  ...
                  <h3 className={styles.tot}>
                    NPR {cartItem.price * cartItem.quantity}
                  </h3>
                <button
                  className={styles.delete}
                  onClick={() => removeFromCart(cartItem.id)}
